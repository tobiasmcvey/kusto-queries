...
Example queries for learning the Kusto Query language in [Azure Data Explorer](https://docs.microsoft.com/en-us/azure/data-explorer/data-explorer-overview). Kusto can be used in Azure Monitor Logs, Application Insights, Time Series Insights and Defender Advanced Threat Perception. 
...
- [Searching](https://github.com/tobmcv/kusto-queries/blob/master/README.md#searching)
- [Time and timerange](https://github.com/tobmcv/kusto-queries/blob/master/README.md#time-and-timerange)
- [Where](https://github.com/tobmcv/kusto-queries/blob/master/README.md#where)
- [Take and Limit command](https://github.com/tobmcv/kusto-queries/blob/master/README.md#take-and-limit-command)
- [Count operator](https://github.com/tobmcv/kusto-queries/blob/master/README.md#count-operator)
- [Summarize](https://github.com/tobmcv/kusto-queries/blob/master/README.md#summarize)
- [Extend](https://github.com/tobmcv/kusto-queries/blob/master/README.md#extend)
